...
pub fn run_baked() -> Vec<Box<Table>> {
    ...
    loop {
        ...
        if b_r26 {
            ...
            if (k as usize) < len_r26 {
                i_r27 = unsafe { *p_r26.add(k as usize) };
            } else {
                panic!("optimizer invariant violated: fast-path bounds check failed");
            }
            i_r28 = i_r27 + 1;
...
pub const STATS: &str = "fast_sets=2;fast_gets=1;dyn_sets=0;dyn_gets=0;hoists=2;hoist_ctx=0,0";
