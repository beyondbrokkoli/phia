...
pub fn run_baked() -> Vec<Box<Table>> {
    ...
    unsafe {
        *t.as_float_mut().get_unchecked_mut(idx) = 0.9000000000000001;
    }
    return tables;
}

pub const STATS: &str = "fast_sets=0;fast_gets=0;dyn_sets=1;dyn_gets=0;hoists=0;hoist_ctx=;consts_i=1;consts_b=0;consts_f=5;consts_s=0";
