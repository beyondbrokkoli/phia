...
pub fn run_baked() -> Vec<Box<Table>> {
    ...
    loop {
        ...
        if b_r5 {
            ...
            len_r7 = unsafe { (*t_r7).as_int_mut().len() };
            p_r7 = unsafe { (*t_r7).as_int_mut().as_mut_ptr() };
            i_r2 = 0;
            loop {
                b_r5 = i_r2 < i_r0;
                if b_r5 {
...
pub const STATS: &str = "fast_sets=1;fast_gets=0;dyn_sets=0;dyn_gets=0;hoists=1;hoist_ctx=1;consts_i=10;consts_b=0;consts_f=0;consts_s=0";
